function ThirdEyebrow03({data}){
    return(
        <svg width="165" height="15" viewBox="0 0 165 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="12" width="25" height="15" rx="5" fill={data?.eyeBrow}/>
            <rect x="128" width="25" height="15" rx="5" fill={data?.eyeBrow}/>
        </svg>
    )
    
}

export default ThirdEyebrow03