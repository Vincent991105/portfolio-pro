function FiveMouth({data}){
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="250" height="75" viewBox="0 0 250 75" fill="none">
            <g clipPath="url(#clip0_44_240)">
                <path d="M212.5 0H37.5C16.7893 0 0 16.7893 0 37.5C0 58.2107 16.7893 75 37.5 75H212.5C233.211 75 250 58.2107 250 37.5C250 16.7893 233.211 0 212.5 0Z" fill={data?.mouth}/>
            </g>
            <defs>
                <pattern
                    id="pattern0_344_267"
            ...
            <defs>
                ...
                <rect width="250" height="75" fill={data?.mouth}/>
                </clipPath>
            </defs>
        </svg>
    )
